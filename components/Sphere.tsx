...
import EmblaCoverCarousel, { type RegisterDragListener } from './EmblaCoverCarousel'
import styles from './Sphere.module.css'
import DragArrowsHint from './DragArrowsHint'

import { CONFIG, KEY_LOCK_ELEVATION } from './Sphere.config'
import { ease, slerpUnit } from './utils/sphereMath'
import { NOISE_DATA_URI } from './utils/noise'
import { makeVerticalHQGradient } from './ui/gradients'
import SlideItem from './ui/SlideItem'
import { quotes, descriptions, categories } from './ui/slidesData'

export default function GoldenMatteSphereSoftLighting() {
      ...
      {sphereDiameterPx > 0 && (
        ...
        >
          <EmblaCoverCarousel
            ...
            items={slides}
            /** Embla → sphere drag */
            publishDrag={(e) => { notifyDrag(e); handleCarouselDrag(e) }}
