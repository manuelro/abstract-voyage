...
// Production stand-in for components/LayoutDebug.panel.ts, produced by scripts/generate-panel-stubs.js.
...
export const LAYOUT_DEBUG_SCOPE_ID: any = (() => {
...
export const LAYOUT_DEBUG_FIELDS: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
...
export const LAYOUT_DEBUG_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
