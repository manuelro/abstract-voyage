...
// Production stand-in for components/PageSurface.panel.ts, produced by scripts/generate-panel-stubs.js.
...
export const PAGE_SURFACE_APPEARANCE_SCOPE_ID: any = (() => {
...
export const PAGE_SURFACE_APPEARANCE_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
