...
// Production stand-in for components/CtaButton/config/colorOverride.panel.ts, produced by scripts/generate-panel-stubs.js.
...
export const createCtaButtonColorOverridePanel: any = (() => {
...
export const ABSTRACT_CTA_BUTTON_COLOR_OVERRIDE_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
...
export const CONTACT_CTA_BUTTON_COLOR_OVERRIDE_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
