export type MagnificationDockSizeOptions = {
  activePct: number
  excludeLeadItem?: boolean
}
...
export const computeMagnificationDockSizes = (
  count: number,
  activeIndex: number | null,
  {
    activePct,
    excludeLeadItem = false,
  }: MagnificationDockSizeOptions,
) => {
  if (count === 0) return []
