...
// Production stand-in for pages/posts/postLab.panel.ts, produced by scripts/generate-panel-stubs.js.
...
export const POST_LAB_PAGE_LAYOUT_SCOPE_ID: any = (() => {
...
export const POST_LAB_PAGE_LAYOUT_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
