...
// Production stand-in for pages/carousel-lab.panel.ts, produced by scripts/generate-panel-stubs.js.
...
export const CAROUSEL_LAB_SCOPE_ID: any = (() => {
...
export const CAROUSEL_LAB_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
