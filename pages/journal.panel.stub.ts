...
// Production stand-in for pages/journal.panel.ts, produced by scripts/generate-panel-stubs.js.
...
export const JOURNAL_TIMELINE_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
...
export const JOURNAL_CARD_APPEARANCE_SCOPE_ID: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
...
export const JOURNAL_POLYMORPHIC_LAYOUT_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
