...
// Production stand-in for pages/about.panel.ts, produced by scripts/generate-panel-stubs.js.
...
export const ABOUT_PAGE_LAYOUT_SCOPE_ID: any = (() => {
...
export const ABOUT_DOCK_PALETTE_SCOPE_ID: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
...
export const ABOUT_TOP_SEGMENT_GRADIENT_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
