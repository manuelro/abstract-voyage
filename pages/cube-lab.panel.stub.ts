...
// Production stand-in for pages/cube-lab.panel.ts, produced by scripts/generate-panel-stubs.js.
...
export const CUBE_LAB_SCOPE_ID: any = (() => {
...
export const CUBE_LAB_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
