...
// Production stand-in for experiences/about/components/AboutTimeline.panel.ts, produced by scripts/generate-panel-stubs.js.
...
export const ABOUT_TIMELINE_PANEL_FIELDS: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
