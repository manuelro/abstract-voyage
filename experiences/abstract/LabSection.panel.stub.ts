...
// Production stand-in for experiences/abstract/LabSection.panel.ts, produced by scripts/generate-panel-stubs.js.
...
export const ABSTRACT_LAB_SECTION_APPEARANCE_SCOPE_ID: any = (() => {
...
export const ABSTRACT_LAB_SECTION_APPEARANCE_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
