...
export const POLYMORPHIC_LAYOUT_BASE_FIELDS: ReadonlyArray<NonTabsEntry<PolymorphicLayoutConfig>> = [
  ...
  },
  {
    ...
    key: 'colorSource',
    label: 'Color source',
    description: 'None: no background, the page surface shows through. Palette: derived from the card coloring engine\'s ramp. Custom: the two fixed colors below. Surface: derived from the page surface color, offset by the amounts below. Scroll gradient: a fixed, full-viewport, scroll-darkening procedural gradient — both columns paint transparent so it shows through.',
    options: [
      { label: 'NONE', value: 'none' },
      { label: 'PALETTE', value: 'palette' },
      { label: 'CUSTOM', value: 'custom' },
      { label: 'SURFACE', value: 'surface' },
      { label: 'SCROLL GRADIENT', value: 'scrollGradient' },
    ],
  },
  {
    kind: 'color',
  ...
  },
  {
    ...
    label: 'Scroll gradient hue',
    description: 'Main hue (0-360) the procedural gradient is built around.',
    min: 0,
    max: 360,
    step: 1,
    unit: '°',
    visibleWhen: config => config.colorSource === 'scrollGradient',
  },
  {
    kind: 'enum',
    key: 'scrollGradientHueScheme',
    label: 'Scroll gradient hue scheme',
  ...
  },
  {
    ...
    label: 'Scroll gradient lightness min',
    min: 0,
    max: 100,
    step: 1,
    visibleWhen: config => config.colorSource === 'scrollGradient',
  },
  {
    ...
    label: 'Scroll gradient chroma min',
    min: 0,
    max: 100,
    step: 1,
    visibleWhen: config => config.colorSource === 'scrollGradient',
  },
  {
    ...
    label: 'Scroll gradient distribution',
  ...
  },
  {
    ...
    label: 'Scroll gradient stop count',
    min: 2,
    max: 64,
    step: 1,
    integer: true,
  ...
  },
  {
    ...
    label: 'Scroll gradient variance',
  ...
  },
  {
    ...
    label: 'Scroll gradient center stretch',
  ...
  },
  {
    ...
    label: 'Scroll gradient ink color',
    description: 'The text/contrast basis every downstream reader of this column\'s color (nav, headings, body copy) derives from while the scroll gradient is active — independent of the palette above.',
    visibleWhen: config => config.colorSource === 'scrollGradient',
  },
  {
    kind: 'number',
    key: 'scrollGradientViewportRangeVh',
    label: 'Scroll gradient darken range',
  ...
  },
  {
    ...
    label: 'Scroll gradient max darken',
  ...
  },
  {
    ...
    integer: true,
    visibleWhen: config => (
      config.colorSource === 'scrollGradient'
      || config.colorSourceWide === 'scrollGradient'
      || config.colorSourceLg === 'scrollGradient'
    ),
  },
  {
    kind: 'boolean',
...
const COLUMN_COLOR_KEYS = new Set<keyof PolymorphicLayoutConfig>([
  ...
  'scrollGradientBaseHue',
  'scrollGradientHueScheme',
  'scrollGradientLightnessMin',
  'scrollGradientChromaMin',
  'scrollGradientMode',
  'scrollGradientStops',
  'scrollGradientVariance',
  'scrollGradientCenterStretch',
  'scrollGradientSeed',
  'scrollGradientInkColor',
  'scrollGradientViewportRangeVh',
                    ...
                    },
                    {
                      ...
                      fields: [
                        ...
                        },
                        {
                          ...
                          label: 'Scroll gradient hue (≥ tablet)',
                          min: 0,
                          max: 360,
                          step: 1,
                          unit: '°',
                          visibleWhen: config => config.colorSourceWide === 'scrollGradient',
                        },
                        {
                          kind: 'enum',
                          key: 'scrollGradientHueSchemeWide',
                          label: 'Scroll gradient hue scheme (≥ tablet)',
                          options: [
                            { label: 'MONO', value: 'mono' },
                            { label: 'DUAL COMPLEMENTARY', value: 'dual-complementary' },
                          ],
                        ...
                        },
                        {
                          ...
                          label: 'Scroll gradient lightness min (≥ tablet)',
                          min: 0,
                          max: 100,
                          step: 1,
                          visibleWhen: config => config.colorSourceWide === 'scrollGradient',
                        },
                        {
                          ...
                          label: 'Scroll gradient chroma min (≥ tablet)',
                          min: 0,
                          max: 100,
                          step: 1,
                          visibleWhen: config => config.colorSourceWide === 'scrollGradient',
                        },
                        {
                          ...
                          label: 'Scroll gradient distribution (≥ tablet)',
                          options: [
                            { label: 'SIDE BRIGHT', value: 'side-bright' },
                            { label: 'CENTER BRIGHT', value: 'center-bright' },
                          ],
                        ...
                        },
                        {
                          ...
                          label: 'Scroll gradient stop count (≥ tablet)',
                          min: 2,
                          max: 64,
                          step: 1,
                          integer: true,
                        ...
                        },
                        {
                          ...
                          label: 'Scroll gradient variance (≥ tablet)',
                          min: 0,
                          max: 1,
                          step: 0.01,
                          visibleWhen: config => config.colorSourceWide === 'scrollGradient',
                        },
                        {
                          ...
                          label: 'Scroll gradient center stretch (≥ tablet)',
                          min: 0,
                          max: 1,
                          step: 0.01,
                          visibleWhen: config => config.colorSourceWide === 'scrollGradient',
                        },
                        {
                          ...
                          label: 'Scroll gradient seed (≥ tablet)',
                          min: 0,
                          max: 100000,
                          step: 1,
                          integer: true,
                        ...
                        },
                        {
                          ...
                          label: 'Scroll gradient ink color (≥ tablet)',
                          visibleWhen: config => config.colorSourceWide === 'scrollGradient',
                        },
                        {
                          kind: 'number',
                          key: 'scrollGradientViewportRangeVhWide',
                          label: 'Scroll gradient darken range (≥ tablet)',
                          min: 0.1,
                          max: 10,
                          step: 0.05,
                          unit: 'vh×',
                        ...
                        },
                        {
                          ...
                          label: 'Scroll gradient max darken (≥ tablet)',
                          min: 0,
                          max: 1,
                          step: 0.01,
                          visibleWhen: config => config.colorSourceWide === 'scrollGradient',
                    ...
                    },
                    {
                      ...
                      fields: [
                        ...
                        },
                        {
                          ...
                          label: 'Scroll gradient hue (≥ desktop)',
                          min: 0,
                          max: 360,
                          step: 1,
                          unit: '°',
                          visibleWhen: config => config.colorSourceLg === 'scrollGradient',
                        },
                        {
                          kind: 'enum',
                          key: 'scrollGradientHueSchemeLg',
                          label: 'Scroll gradient hue scheme (≥ desktop)',
                          options: [
                            { label: 'MONO', value: 'mono' },
                            { label: 'DUAL COMPLEMENTARY', value: 'dual-complementary' },
                          ],
                        ...
                        },
                        {
                          ...
                          label: 'Scroll gradient lightness min (≥ desktop)',
                          min: 0,
                          max: 100,
                          step: 1,
                          visibleWhen: config => config.colorSourceLg === 'scrollGradient',
                        },
                        {
                          ...
                          label: 'Scroll gradient chroma min (≥ desktop)',
                          min: 0,
                          max: 100,
                          step: 1,
                          visibleWhen: config => config.colorSourceLg === 'scrollGradient',
                        },
                        {
                          ...
                          label: 'Scroll gradient distribution (≥ desktop)',
                          options: [
                            { label: 'SIDE BRIGHT', value: 'side-bright' },
                            { label: 'CENTER BRIGHT', value: 'center-bright' },
                          ],
                        ...
                        },
                        {
                          ...
                          label: 'Scroll gradient stop count (≥ desktop)',
                          min: 2,
                          max: 64,
                          step: 1,
                          integer: true,
                        ...
                        },
                        {
                          ...
                          label: 'Scroll gradient variance (≥ desktop)',
                          min: 0,
                          max: 1,
                          step: 0.01,
                          visibleWhen: config => config.colorSourceLg === 'scrollGradient',
                        },
                        {
                          ...
                          label: 'Scroll gradient center stretch (≥ desktop)',
                          min: 0,
                          max: 1,
                          step: 0.01,
                          visibleWhen: config => config.colorSourceLg === 'scrollGradient',
                        },
                        {
                          ...
                          label: 'Scroll gradient seed (≥ desktop)',
                          min: 0,
                          max: 100000,
                          step: 1,
                          integer: true,
                        ...
                        },
                        {
                          ...
                          label: 'Scroll gradient ink color (≥ desktop)',
                          visibleWhen: config => config.colorSourceLg === 'scrollGradient',
                        },
                        {
                          kind: 'number',
                          key: 'scrollGradientViewportRangeVhLg',
                          label: 'Scroll gradient darken range (≥ desktop)',
                          min: 0.1,
                          max: 10,
                          step: 0.05,
                          unit: 'vh×',
                        ...
                        },
                        {
                          ...
                          label: 'Scroll gradient max darken (≥ desktop)',
                          min: 0,
                          max: 1,
                          step: 0.01,
                          visibleWhen: config => config.colorSourceLg === 'scrollGradient',
