...
export const ABSTRACT_POLYMORPHIC_LAYOUT_CONFIG: PolymorphicLayoutConfig = {
  ...
  scrollGradientBaseHue: 222,
  scrollGradientHueScheme: 'dual-complementary',
  scrollGradientLightnessMin: 11,
  scrollGradientChromaMin: 30,
  scrollGradientMode: 'center-bright',
  scrollGradientStops: 50,
  scrollGradientVariance: 1,
  scrollGradientCenterStretch: 0.25,
  scrollGradientSeed: 836,
  ...
  headerLeftContentPaddingTop: 'pt-7',
  ...
  headerRightContentPaddingTop: 'pt-10',
...
export const ABOUT_POLYMORPHIC_LAYOUT_CONFIG: PolymorphicLayoutConfig = {
  ...
  wideColumnSurfaceOffset: 0,
  narrowColumnSurfaceOffset: 0,
  // scrollGradient* defaults — see the doc comment on this same field block
  // in ABSTRACT_POLYMORPHIC_LAYOUT_CONFIG above.
