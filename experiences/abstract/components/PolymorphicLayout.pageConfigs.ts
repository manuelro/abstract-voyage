...
export const ABSTRACT_POLYMORPHIC_LAYOUT_CONFIG: PolymorphicLayoutConfig = {
  ...
  // (base/Wide/Lg) — so turning wordmarkUsesScrollGradient on with nothing
  // else touched renders in the same palette family as today's
  // inherit-from-background behavior. lightnessMin/-Max intentionally do
  // NOT copy scrollGradientLightnessMin (11/10/10 — tuned for a moody
  // full-viewport backdrop) — 18/58 is the wordmark's own
  // legibility-appropriate default range instead.
  ...
  narrowColumnContentPaddingLeft: 'pl-10',
  ...
  narrowColumnContentPaddingRight: 'pr-10',
  narrowColumnContentPaddingTop: 'pt-0',
  narrowColumnContentPaddingTopWide: 'md:pt-16',
  narrowColumnContentPaddingTopLg: 'lg:pt-40',
  narrowColumnContentPaddingBottom: 'pb-14',
  ...
  headerRightSegmentVerticalAlign: 'items-end',
  ...
  headerRightInnerAlign: 'justify-start',
  ...
  narrowColumnCustomColorLg: '#535369',
...
export const ABOUT_POLYMORPHIC_LAYOUT_CONFIG: PolymorphicLayoutConfig = {
  ...
  // mobile background rather than inventing a second, independently-tuned
  // palette for the identical mechanism.
  scrollGradientEnabled: true,
  scrollGradientEnabledWide: false,
  scrollGradientEnabledLg: false,
  ...
  wideColumnSurfaceOffset: 0,
  narrowColumnSurfaceOffset: 0,
  // scrollGradient* defaults — kept in sync with ABSTRACT_POLYMORPHIC_
  // LAYOUT_CONFIG's own base/mobile-tier values above verbatim (re-synced
  // once already after an in-panel edit to /abstract's own values drifted
  // these — same "first gradient" reuse, not a second independently-tuned
  // palette).
  scrollGradientBaseHue: 190,
  scrollGradientHueScheme: 'dual-complementary',
  scrollGradientLightnessMin: 50,
  ...
  headerSplitBandEnabled: true,
  // 'transparent'/'transparent' below (base/mobile tier only) — copied
  // verbatim from ABSTRACT_POLYMORPHIC_LAYOUT_CONFIG's own mobile-tier
  // values (Wide/Lg below untouched) so /about's mobile header reads
  // identically to /abstract's: no dark translucent band showing through
  // behind the wordmark/nav, per explicit operator ask (screenshot-
  // reported: About's own 'syncWithColumnBelow'/'custom' mobile values
  // painted a visible dark band Abstract's mobile header never has).
  splitBandLeftMode: 'transparent',
  splitBandLeftCustomColor: '#0e1230',
  ...
  narrowColumnContentMarginLeftWide: 'md:ml-0',
  narrowColumnContentMarginLeftLg: 'lg:ml-0',
  wideColumnContentPaddingLeft: 'pl-3',
  wideColumnContentPaddingRight: 'pr-3',
  ...
  wideColumnContentPaddingBottom: 'pb-14',
  ...
  headerRightSegmentAlignWide: 'md:justify-start',
  headerRightSegmentAlignLg: 'lg:justify-start',
  // items-end/justify-start/pt-8 below (base/mobile tier only) — copied
  // verbatim from ABSTRACT_POLYMORPHIC_LAYOUT_CONFIG's own mobile-tier
  // values (this page's own Wide/Lg tiers below are untouched) so /about's
  // mobile header/nav top spacing matches /abstract's exactly, per explicit
  // operator ask.
  headerRightSegmentVerticalAlign: 'items-end',
  headerRightSegmentVerticalAlignWide: 'md:items-center',
  headerRightSegmentVerticalAlignLg: 'lg:items-center',
