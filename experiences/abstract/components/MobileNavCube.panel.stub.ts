...
// Production stand-in for experiences/abstract/components/MobileNavCube.panel.ts, produced by scripts/generate-panel-stubs.js.
...
export const MOBILE_NAV_CUBE_SCOPE_ID: any = (() => {
...
export const MOBILE_NAV_CUBE_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
