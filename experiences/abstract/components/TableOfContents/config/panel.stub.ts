...
// Production stand-in for experiences/abstract/components/TableOfContents/config/panel.ts, produced by scripts/generate-panel-stubs.js.
...
export const POST_LAB_ARTICLE_TOC_SCOPE_ID: any = (() => {
...
export const POST_LAB_ARTICLE_TOC_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
