...
export const DEFAULT_POST_LAB_ARTICLE_CONFIG = {
  ...
  bodyTextMinContrast: 4.1,
  bodyTextOriginalHueRetention: 1,
  bodyTextHueShiftDegrees: 0,
  bodyTextPigmentIntensity: 0.71,
  mutedTextMinContrast: 11.7,
  linkTextMinContrast: 12.3,
  linkPigmentIntensity: 0,
  richBlockMarginY: 'my-12',
