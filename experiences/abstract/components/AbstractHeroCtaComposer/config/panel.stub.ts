...
// Production stand-in for experiences/abstract/components/AbstractHeroCtaComposer/config/panel.ts, produced by scripts/generate-panel-stubs.js.
...
export const ABSTRACT_HERO_CTA_COMPOSER_ENTRANCE_SCOPE_ID: any = (() => {
...
export const ABSTRACT_HERO_CTA_COMPOSER_ENTRANCE_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
