...
// Production stand-in for experiences/abstract/components/AbstractMetalLabList.panel.ts, produced by scripts/generate-panel-stubs.js.
...
export const ABSTRACT_METAL_LAB_CARD_SCOPE_ID: any = (() => {
...
export const ABSTRACT_METAL_LAB_CARD_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
