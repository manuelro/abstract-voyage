...
// Production stand-in for experiences/abstract/components/AbstractJournalLabCollection/config/slider.panel.ts, produced by scripts/generate-panel-stubs.js.
...
export const ABSTRACT_JOURNAL_LAB_COLLECTION_SLIDER_SCOPE_ID: any = (() => {
...
export const ABSTRACT_JOURNAL_LAB_COLLECTION_SLIDER_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
