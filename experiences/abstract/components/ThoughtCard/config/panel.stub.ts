...
// Production stand-in for experiences/abstract/components/ThoughtCard/config/panel.ts, produced by scripts/generate-panel-stubs.js.
...
export const THOUGHT_CARD_SCOPE_ID: any = (() => {
...
export const THOUGHT_CARD_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
