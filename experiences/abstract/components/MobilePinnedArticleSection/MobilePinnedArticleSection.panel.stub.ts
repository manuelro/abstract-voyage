...
// Production stand-in for experiences/abstract/components/MobilePinnedArticleSection/MobilePinnedArticleSection.panel.ts, produced by scripts/generate-panel-stubs.js.
...
export const MOBILE_PINNED_ARTICLE_SECTION_SCOPE_ID: any = (() => {
...
export const MOBILE_PINNED_ARTICLE_SECTION_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
