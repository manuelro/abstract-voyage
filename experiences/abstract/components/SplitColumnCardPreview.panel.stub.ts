...
// Production stand-in for experiences/abstract/components/SplitColumnCardPreview.panel.ts, produced by scripts/generate-panel-stubs.js.
...
export const SPLIT_COLUMN_CARD_PREVIEW_SCOPE_ID: any = (() => {
...
export const SPLIT_COLUMN_CARD_PREVIEW_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
