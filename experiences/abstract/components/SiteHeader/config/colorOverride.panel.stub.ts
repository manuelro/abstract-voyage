...
// Production stand-in for experiences/abstract/components/SiteHeader/config/colorOverride.panel.ts, produced by scripts/generate-panel-stubs.js.
...
export const createSiteHeaderColorOverridePanel: any = (() => {
...
export const ABOUT_SITE_HEADER_COLOR_OVERRIDE_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
...
export const CONTACT_SITE_HEADER_COLOR_OVERRIDE_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
...
export const ABSTRACT_SITE_HEADER_COLOR_OVERRIDE_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
...
export const POSTS_LAB_SITE_HEADER_COLOR_OVERRIDE_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
