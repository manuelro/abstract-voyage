...
// Production stand-in for experiences/abstract/components/SiteHeader/config/wordmark.panel.ts, produced by scripts/generate-panel-stubs.js.
...
export const WORDMARK_SCOPE_ID: any = (() => {
...
export const WORDMARK_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
