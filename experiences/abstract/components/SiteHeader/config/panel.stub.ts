...
// Production stand-in for experiences/abstract/components/SiteHeader/config/panel.ts, produced by scripts/generate-panel-stubs.js.
...
export const SITE_HEADER_COLORS_SCOPE_ID: any = (() => {
...
export const SITE_HEADER_COLOR_FIELDS: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
...
export const SITE_HEADER_COLORS_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
