...
// Production stand-in for experiences/abstract/components/Card/config/appearance.panel.ts, produced by scripts/generate-panel-stubs.js.
...
export const CARD_APPEARANCE_SCOPE_ID: any = (() => {
...
export const CARD_APPEARANCE_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
