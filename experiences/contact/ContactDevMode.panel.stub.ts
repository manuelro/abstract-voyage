...
// Production stand-in for experiences/contact/ContactDevMode.panel.ts, produced by scripts/generate-panel-stubs.js.
...
export const CONTACT_DEV_MODE_SCOPE_ID: any = (() => {
...
export const CONTACT_DEV_MODE_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
