...
// Production stand-in for experiences/contact/ContactExperience.panel.ts, produced by scripts/generate-panel-stubs.js.
...
export const CONTACT_EXPERIENCE_SCOPE_ID: any = (() => {
...
export const CONTACT_EXPERIENCE_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
