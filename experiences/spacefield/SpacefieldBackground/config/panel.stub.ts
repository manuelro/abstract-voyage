...
// Production stand-in for experiences/spacefield/SpacefieldBackground/config/panel.ts, produced by scripts/generate-panel-stubs.js.
...
export const SPACEFIELD_SCOPE_ID: any = (() => {
...
export const SPACEFIELD_PANEL: any = (() => {
  const p: any = new Proxy(() => undefined, {
    get(t, prop) { return prop in t ? (t as any)[prop] : p },
    apply() { return undefined },
  })
