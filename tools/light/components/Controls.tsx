...
export default function Controls({
  ...
  return (
    <section className="rounded-xl text-[var(--on-surface)] p-4 md:p-6 controls">
      ...
      {/* Row 0: Enable secondary toggle (palette selection is global now) */}
      <div className="row" style={{ justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
        <div className="row" style={{ alignItems: 'center', gap: 8 }}>
          ...
          />
          <label htmlFor="enableSecondary" className="text-sm">Enable secondary accent</label>
        </div>
      </div>
      ...
      <div className="d-flex flex flex-row md:flex-nowrap flex-wrap justify-between items-end gap-3 md:gap-4">
        ...
        <div className="flex flex-col gap-1 min-w-[260px] flex-1">
          <label htmlFor="deltaScale" className="text-sm">Delta (spacing)</label>
          <select
            id="deltaScale"
        ...
        <div className="flex flex-col gap-1 min-w-[160px]">
          <label htmlFor="numLevels" className="text-sm">Steps (3–10)</label>
          <select
            id="numLevels"
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
        <fieldset className="rounded-md border border-[var(--muted)] p-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="h-9 w-24 rounded-md border border-[var(--muted)] bg-[var(--elevated)] px-2"
            />
          </div>
        </fieldset>
        ...
        <fieldset className="rounded-md border border-[var(--muted)] p-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="h-9 rounded-md border border-[var(--muted)] bg-[var(--elevated)] px-2"
            >
