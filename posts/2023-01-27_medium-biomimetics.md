...
_Figure. Fig. A — This figure represents the similarity of the user interface with the conscious entity (the human), which translates to highly efficient user interfaces due to low rejection rates._
...
<!-- table:human-communication-traits -->
_Figure 2. Human communication trait categories used in the framework._
...
<!-- table:gorilla-communication-traits -->
_Figure 3. Communication traits mapped against a gorilla interaction model._
...
<!-- table:human-communication-rank -->
_Figure 4. Communication trait categories mapped to human-to-human interaction._
